...
from .modules import authorize, list, clone, delete, count, leech_settings, search, shell, eval, tg_to_tf_uploader, url_uploader
...
def main():
    ...
    stats_handler = CommandHandler(BotCommands.StatsCommand,
                                   stats, filters=CustomFilters.authorized_user, run_async=True)
